  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-zibal" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="zibal_api"><?php echo $entry_api; ?></label>
                <div class="col-sm-10">
                  <input name="zibal_api" type="text" value="<?php echo $zibal_api; ?>" class="form-control" style="direction:ltr;" />
